...
void USBDeviceHandleSI::EventThread()
{
   ...
   try
   {
      ...
      {
         #if defined(DEBUG_FILE)
            DSIDebug::ThreadWrite("USBDeviceHandleSI::EventThread: mach_port NULL!");
         #endif
         throw;
      }
      ...
      {
         #if defined(DEBUG_FILE)
            DSIDebug::ThreadWrite("USBDeviceHandleSI::EventThread: notification_port NULL!");
         #endif
         throw;
      }
      ...
      {
         #if defined(DEBUG_FILE)
            DSIDebug::ThreadWrite("USBDeviceHandleSI::EventThread: notification_source NULL!");
         #endif
         throw;
      }
      ...
      {
         #if defined(DEBUG_FILE)
            DSIDebug::ThreadWrite("USBDeviceHandleSI::EventThread: IOServiceAddMatchingNotification failed");
         #endif
         throw;
      }
   }
   ...
   {
      #if defined(DEBUG_FILE)
         DSIDebug::ThreadWrite("USBDeviceHandleSI::EventThread: starting catch( ... )");
      #endif
